<div>
    ...
    @push('js')
        <script>
            ...
            function loadStates() {
                fetch("https://api.copomex.com/query/get_estados?token=954d01ff-6b01-4236-af4e-42d9ab11a474")
            ...
            function loadColonias(cp) {
                fetch(`https://api.copomex.com/query/get_colonia_por_cp/${cp}?token=954d01ff-6b01-4236-af4e-42d9ab11a474`)
                    .then(res => res.ok ? res.json() : Promise.reject(res))
                    .then(json => {
                        console.log(json);
